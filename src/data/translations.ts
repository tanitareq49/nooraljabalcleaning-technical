export const translations = {
  en: {
    ...
    services: {
      ...
      generalCleaning: {
        ...
        items: [
          ...
          "Window Cleaning",
          "Window Outside Cleaning",
          "Window Inside Cleaning",
    ...
    // Why Choose Us
    whyChoose: {
      title: "Why Choose Noor Al Jabal?",
  ...
  ar: {
    ...
    services: {
      ...
      deepCleaning: {
        ...
        items: [
          "تنظيف عميق للفيلات والشقق",
          "تنظيف عميق للمباني العامة",
          "تنظيف عميق للمكاتب",
          "تنظيف مجاري المكيف",
          "تنظيف ما بعد البناء",
    ...
    // Why Choose Us
    whyChoose: {
      title: "لماذا تختار نور الجبل؟",
      subtitle: "رضاكم هو أولويتنا",
      items: [
        {
          title: "فريق ذو خبرة",
    ...
    testimonials: {
      ...
      subtitle: "تقييمات حقيقية من عملاء راضين",
      items: [
        {
          name: "أحمد الراشد",
