      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 fade-in-up">
            ...
            <div className="bg-card rounded-2xl p-8 shadow-soft text-center card-hover">
              ...
              <h3 className={`text-xl font-bold text-card-foreground mb-3 ${isRTL ? 'font-arabic' : 'font-english'}`}>
                {isRTL ? 'اتصل بنا' : 'Call Us'}
              </h3>
              <a 
                href="tel:+966123456789"
                className={`text-muted-foreground hover:text-primary transition-colors text-lg ${isRTL ? 'font-arabic' : 'font-english'}`}
              >
            ...
            <div className="bg-card rounded-2xl p-8 shadow-soft text-center card-hover">
              ...
              <p className={`text-muted-foreground text-lg ${isRTL ? 'font-arabic' : 'font-english'}`}>
                {t.contact.info.address}
              </p>
              <div className={`mt-4 text-sm text-muted-foreground ${isRTL ? 'font-arabic' : 'font-english'}`}>
            ...
            <div className="bg-card rounded-2xl p-8 shadow-soft text-center card-hover">
              ...
              <p className={`text-muted-foreground text-lg ${isRTL ? 'font-arabic' : 'font-english'}`}>
                {isRTL ? 'للرد السريع والحجز الفوري' : 'For quick response & instant booking'}
              </p>
              <a
        ...
        <div className="mt-16 fade-in-up">
          <div className="bg-primary/5 rounded-2xl p-8 text-center">
            <h3 className={`text-2xl font-bold text-foreground mb-4 ${isRTL ? 'font-arabic' : 'font-english'}`}>
              {isRTL ? 'خدمة عملاء 24/7' : '24/7 Customer Service'}
            </h3>
            <p className={`text-muted-foreground max-w-2xl mx-auto mb-6 ${isRTL ? 'font-arabic' : 'font-english'}`}>
              {isRTL 
