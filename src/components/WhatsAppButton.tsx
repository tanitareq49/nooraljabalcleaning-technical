...
const WhatsAppButton = () => {
  ...
  const whatsappUrl = `https://wa.me/+971509487147?text=${encodeURIComponent(
    whatsappMessage
  )}`;
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <div
        className={`absolute bottom-full mb-2 px-3 py-2 bg-gray-900 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap ${
