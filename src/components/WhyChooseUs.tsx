          ...
          {t.whyChoose.items.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Content */}
                <h3 className={`text-xl font-bold text-card-foreground mb-4 ${isRTL ? 'font-arabic' : 'font-english'}`}>
                  {item.title}
                </h3>
        ...
        <div className="mt-20 bg-gradient-primary rounded-2xl p-8 md:p-12 text-center fade-in-up">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <div className={`text-primary-foreground/80 ${isRTL ? 'font-arabic' : 'font-english'}`}>
