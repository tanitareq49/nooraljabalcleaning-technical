          ...
          <div className={`fade-in-up ${isRTL ? "lg:order-1" : ""}`}>
            <div className="relative">
              ...
              <div className="bg-gradient-primary rounded-2xl p-8 text-center shadow-strong">
                ...
                <div className="text-primary-foreground/80 text-lg mb-6">
                  Noor Al Jabal
                </div>
                <div
              ...
              <div
                className="absolute -top-8 left-1/2 w-12 h-12 bg-primary-light/20 rounded-full blur-xl floating-animation"
